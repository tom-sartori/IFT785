...
from fake_crypto import sign, verify, sha, new_deterministic_hash
...
class GenericBlock():
    ...
    def add_data(self, new_key, new_value):
        """
        add new entry to the data dictionary {key: value}
        update the hash_root
        should not be used after signature
        """
        ...
        if self._signature is not None:
            print("Warning: data added to an already signed block")
